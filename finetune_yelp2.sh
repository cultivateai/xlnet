...
export YELP_DIR='/home/andyhorng/xlnet/yelp_dataset/yelp_review_polarity_csv'
...
python run_classifier.py \
  ...
  --task_name=yelp2 \
  --data_dir=${YELP_DIR} \
  --output_dir=${GS_ROOT}/proc_data/yelp2 \
  --model_dir=${GS_ROOT}/exp/yelp2 \
  --uncased=False \
...
export MODEL_DIR=${STORAGE_BUCKET}/exp/yelp2
